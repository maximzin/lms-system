...
public class TeacherServiceImpl implements TeacherService {
    ...
    public TeacherSummaryDto createTeacher(TeacherCreateDto dto) {
        ...
        TeacherSummaryDto responseDto = teacherMapper.toSummaryResponse(newTeacher);
    ...
    public TeacherWithCoursesDto getTeacher(UUID id) {
        ...
        TeacherWithCoursesDto responseDto = teacherMapper.toResponseWithCourses(foundTeacher, courseList);
        return responseDto;
    }
